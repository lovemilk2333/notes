---
title: 在 Wifi Stick (随身 WIFI 棒子) 上配置 USB 网路共享 (RNDIS)
...
2. 删除 NetworkManager Connection
...
运行如下命令删除使用 `usb0` 的 NetworkManager Connection
...
此时将 Wifi Stick 插入 Windows 设备的 USB 接口, 应该可以在 Windows 侧看到一个驱动未安装 (代码: 28) 的 RNDIS 设备 (位于 _其他设备_ 类别)
